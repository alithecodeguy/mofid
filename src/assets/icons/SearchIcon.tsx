...
export default function SearchIcon() {
	return (
		<svg
			...
			xmlSpace="preserve"
		>
			<text transform="matrix(1 0 0 1 168.783 543.8093)" fill="#FFFF00" fontFamily="'Verdana-Bold'" fontSize="20">
				simpleicon.com
			</text>
			<text transform="matrix(1 0 0 1 9.1931 567.8093)" fill="#FFFF00" fontFamily="'Verdana'" fontSize="20">
